...
# src/retreival_graph/researcher_graph/graph.py
...
# retrieve_documents function within researcher_graph
...
# retrieve_in_parallel function within researcher graph
...
builder.add_conditional_edges("generate_queries", retrieve_in_parallel, path_map=["retrieve_documents"])
...
# try:
#   display(Image(Researcher_graph.get_graph(xray=True).draw_mermaid_png()))
# except Exception:
#   pass